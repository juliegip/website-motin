...
export interface ApiActuActu extends Schema.CollectionType {
  ...
  attributes: {
    ...
    date: Attribute.Date &
      Attribute.Required &
      Attribute.DefaultTo<'2024-04-03'>;
    media: Attribute.Media;
    category: Attribute.Enumeration<
      ['Promotions', 'Innovations', 'Massey Ferguson', 'Autres']
    > &
      Attribute.Required;
...
export interface ApiBandeauBandeau extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Debut_affichage: Attribute.Date & Attribute.Required;
    Fin_affichage: Attribute.Date & Attribute.Required;
...
export interface ApiRecrutementRecrutement extends Schema.CollectionType {
  ...
  attributes: {
    ...
    contractType: Attribute.Enumeration<
      ['CDI', 'CDD', 'Alternance', 'Stage', 'Int\u00E9rim']
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
